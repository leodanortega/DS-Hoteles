...
* **Gestión de Concurrencia:** Se utiliza **Bloqueo Optimista** en el registro de la habitación durante la ventana de pago para permitir que múltiples usuarios intenten reservar, y solo al final validar la versión del registro.
