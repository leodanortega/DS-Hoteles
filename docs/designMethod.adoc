...
Para comprender adecuadamente la justificación del diseño propuesto, es necesario recordar qué implica trabajar con una arquitectura en capas. Este tipo de arquitectura se fundamenta en la división del sistema en capas bien definidas, independientes y especializadas, que colaboran entre sí mediante interfaces claramente establecidas.

En el diagrama correspondiente a esta sección del proyecto se representarán los distintos componentes del sistema mediante bloques o unidades funcionales, con el fin de ilustrar de forma general la estructura prevista y las relaciones entre sus capas principales.

Falta explicación de los distintos sistemas identificados, propósito y responsabilidad, métodos de los sistemas